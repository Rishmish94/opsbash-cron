...
| Kubernetes RBAC Visualizer | [/k8s-rbac-visualizer](https://opsbash.com/k8s-rbac-visualizer) | Paste Role, ClusterRole, RoleBinding and ClusterRoleBinding YAML and see effective permissions per subject |
